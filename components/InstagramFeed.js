    ...
    <>
      ...
      <div className="bg-gray-50">
          <div className="space-y-12">
            <Header />
        <div className="bg-white  mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-12">
            <ul className="space-y-12 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 sm:space-y-0 lg:grid-cols-3 lg:gap-x-8">
              {instagramPosts.map(({ node }, i) => {
                return <List node={node} key={node.shortcode} />
              })}
            </ul>
          </div>
        </div>
...
const Header = () => (
  ...
  <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
    <div className="mt-8 flex justify-center space-x-6">
      ...
      <a href="https://www.instagram.com/tougane_yomiuri/" target="_blank" className="text-gray-400 hover:text-gray-500">
